...
#find /Users/buildy/Documents/$1/ModumatePackaged/MacNoEditor/Modumate-Mac-Shipping.app/Contents | grep .framework | xargs codesign -f -v -s "Developer ID Application: Modumate, Inc. (44CC46TSLW)" --options runtime --timestamp
