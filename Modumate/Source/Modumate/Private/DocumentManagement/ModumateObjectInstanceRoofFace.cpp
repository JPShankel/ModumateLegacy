...
namespace Modumate
{
	...
	FMOIRoofFaceImpl::FMOIRoofFaceImpl(FModumateObjectInstance *moi)
		: FDynamicModumateObjectInstanceImpl(moi)
		, bAdjustmentHandlesVisible(false)
	{
	}

	FMOIRoofFaceImpl::~FMOIRoofFaceImpl()
	{
	}

	FVector FMOIRoofFaceImpl::GetCorner(int32 index) const
	{
	...
	void FMOIRoofFaceImpl::SetupDynamicGeometry()
	{
		GotGeometry = true;
	...
	void FMOIRoofFaceImpl::UpdateDynamicGeometry()
	{
		SetupDynamicGeometry();
	}

	void FMOIRoofFaceImpl::SetupAdjustmentHandles(AEditModelPlayerController_CPP *controller)
	{
	...
	void FMOIRoofFaceImpl::GetStructuralPointsAndLines(TArray<FStructurePoint> &outPoints, TArray<FStructureLine> &outLines, bool bForSnapping, bool bForSelection) const
	{
