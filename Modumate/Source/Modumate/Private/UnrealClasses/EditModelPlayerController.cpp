...
bool AEditModelPlayerController::BeginWithPlayerState()
{
	...
	// Take thumbnail image after 1 sec upon project load
	GetWorldTimerManager().SetTimer(AutoUploadWebThumbnailTimer, this, &AEditModelPlayerController::OnAutoUploadWebThumbnailTimer, 60.0f, false, 1.0f);
