...
namespace Modumate
{
	FSplitObjectTool::FSplitObjectTool(AEditModelPlayerController_CPP *pc)
	...
	FSplitObjectTool::~FSplitObjectTool()
	{ }

	bool FSplitObjectTool::Activate()
	{
	...
	bool FSplitObjectTool::Deactivate()
	{
	...
	bool FSplitObjectTool::BeginUse()
	{
	...
	bool FSplitObjectTool::EnterNextStage()
	{
		switch (Stage)
		{
	...
	bool FSplitObjectTool::AbortUse()
	{
	...
	bool FSplitObjectTool::FrameUpdate()
	{
	...
	bool FSplitObjectTool::PerformSplit() const
	{
	...
	bool FSplitObjectTool::HasValidEdgeSplitTarget() const
	{
		if (LastValidTarget)
		{
			switch (LastValidTarget->ObjectType)
	...
	bool FSplitObjectTool::HasValidCornerHoverTarget() const
	{
		if (LastValidTarget)
		{
			switch (LastValidTarget->ObjectType)
	...
	bool FSplitObjectTool::HasValidCornerSplitTarget() const
	{
		if (LastValidTarget)
		{
			switch (LastValidTarget->ObjectType)
	...
	bool FSplitObjectTool::FindSplitTarget(const FModumateObjectInstance *moi, const FSnappedCursor &snapCursor, ESplitStage splitStage,
	...
	{
		return new FSplitObjectTool(controller);
	}
}