...
static bool testVariableExtraction()
{
	...
	Expression::ExtractVariables(TEXT("1.75*Globe.Radius + (5 1/2) * TotalArea + 15/(Self.Part_Frame.NativeSizeX)"), outVars);
	if (outVars.Num() != 3)
	{
		return false;
	}
	...
	bool FModumateDimensionFormatUnitTest::RunTest(const FString& Parameters)
{
	...
	static TArray<TestCase> testCases = { 
		...
		{TEXT("5-ft-8-in-7/8in"),EDimensionFormat::FeetAndInches,UModumateDimensionStatics::InchesToCentimeters * (5.0 * 12.0 + 8.0 + 7.0 / 8.0)},
		{TEXT("in-5ft8in7/8in"),EDimensionFormat::FeetAndInches,UModumateDimensionStatics::InchesToCentimeters * (5.0 * 12.0 + 8.0 + 7.0 / 8.0)*-1.0},
		...
		{TEXT("7- 3/4in"),EDimensionFormat::JustInches,UModumateDimensionStatics::InchesToCentimeters * (7 + 0.75)},
		{TEXT("7 - 3/4in"),EDimensionFormat::JustInches,UModumateDimensionStatics::InchesToCentimeters * (7 + 0.75)},
		{TEXT("-7 3/4in"),EDimensionFormat::JustInches,UModumateDimensionStatics::InchesToCentimeters * (7 + 0.75)*-1.0},
		{TEXT("ff-- ss 7- -3/4in"),EDimensionFormat::JustInches,UModumateDimensionStatics::InchesToCentimeters * (7 + 0.75) * -1.0},
