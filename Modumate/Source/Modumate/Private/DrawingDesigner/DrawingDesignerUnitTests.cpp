...
bool FModumateDrawingDesignerViewTest::RunTest(const FString& Parameters)
{
	...
	req.minimumResolutionPixels.x = 500;
	req.minimumResolutionPixels.y = 500;
	req.moiId = 999;

	FDrawingDesignerDrawingImage image;
	image.view = moi;
	image.imageBase64 = TEXT("");
