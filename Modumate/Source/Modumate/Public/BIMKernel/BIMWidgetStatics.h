...
public:
	...
	static ECraftingResult GetPropertyTipsByIconType(const FModumateDatabase &InDB, EConfiguratorNodeIconType IconType, const FBIMAssemblySpec &PresetProperties, TArray<FString> &OutTips);
