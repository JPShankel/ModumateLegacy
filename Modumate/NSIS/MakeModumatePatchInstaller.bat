...
"%NSIS_DIR%\Bin\makensis.exe" /DPRODUCT_VERSION="%NEW_VERSION%" /DPREVIOUS_VERSION="%PREVIOUS_VERSION%" /DPATH_OUT_ROOT="%INSTALLER_DIR%" /DBUILD_DIR="%BUILDS_ROOT%\Patch" Modumate\NSIS\ModumateSetupPatch.nsi
